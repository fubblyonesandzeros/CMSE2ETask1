...
from models import ResNetWithChannelSpatialAttention, Classifier
...
for epoch in range(50):
    ...
    if test_loss < best_test_loss:
        ...
        torch.save(checkpoint, "resnet_attn_classifier_checkpoint.pt")
    ...
    torch.save(performance_checkpoint, "resnet_attn_classifier_performance_checkpoint.pt")